...
<template>
  <div class="demo">
    ...
    <Teleport to="body">
      ...
      <div v-if="isActive && stage" class="hl-cutout" :style="cutout" @click.self="driver.destroy()" />
      <div v-if="isActive && popover" ref="card" class="hl-card" :style="floatingStyles" :data-side="side">
